...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mCenterText.setTextColor(TITLE_COLOR);
        ...
        mSubTitleText.setTextColor(TITLE_COLOR);
        mSubTitleText.setEllipsize(TextUtils.TruncateAt.END);

        mRightLayout.setPadding(0, 0, mOutPadding, 0);
//        mRightLayout.setBackgroundResource(android.R.color.holo_green_light);
    ...
    public void setLeftImageResource(int resId) {
        ...
        // 这一步必须要做,否则不会显示.
        //drawable2.setBounds(0, 0, dip2px(20), dip2px(30));//第一0是距左边距离，第二0是距上边距离，50分别是长宽
        //mLeftText.setCompoundDrawables(drawable2,null,null,null);
